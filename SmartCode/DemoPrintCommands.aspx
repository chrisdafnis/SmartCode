<%@ Page Title="Print Commands" Language="C#" MasterPageFile="~/MasterPage.master" %>
...
<link href="<%=MyUtils.GetWebsiteRoot() + "/content/formToWizard2.css"%>" rel="stylesheet">
...
<script type="text/javascript" src="<%=MyUtils.GetWebsiteRoot() + "/scripts/formToWizard2.js"%>"></script>
    
<script type="text/javascript" src="<%=MyUtils.GetWebsiteRoot() + "/scripts/DemoPrintCommands.js"%>"></script>


<%-- Register the WebClientPrint script code --%>
<%=Neodynamic.SDK.Web.WebClientPrint.CreateScript(MyUtils.GetWebsiteRoot() + "/DemoPrintCommands.ashx")%>
