...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <nav class="jumbotron">
        <nav class="dbtable">
            <asp:Login ID="Login1" runat="server" Width="250px" BackColor="#EFF3FB" BorderColor="#B5C7DE" BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" ForeColor="#333333" CssClass="button" OnAuthenticate="ValidateUser" DestinationPageUrl="Items.aspx">
